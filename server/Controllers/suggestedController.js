...
module.exports = {
    getMovies: (req, res) => {
        ...
        axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=b0905bacefecc34fb178a826419bdf12&language=en-US&page=10`)
        .then(response => {
                                    ...
                                    movieList = [...movieList, ...response.data.results]
                                        ...
                                        .then(response => {
                                            movieList = [...movieList, ...response.data.results]
                                                ...
                                                .then(response => {
                                                    movieList =[...movieList, ...response.data.results]
                                                        axios.get('https://api.themoviedb.org/3/movie/popular?api_key=b0905bacefecc34fb178a826419bdf12&language=en-US&page=9')
                                                        .then(response => {
                                                            movieList = [...movieList, ...response.data.results]
